...
#'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    while b > 0: #цикл: пока переменная b больше 0 -->
            if b % 2 == 0: #условие: если b % 2 равно 0 то -->
...
#''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    while a > 0: #цикл: пока переменная a больше 0 -->
        number = a % 10 #переменная number равна a % 10
        a = a // 10 #переменная a равна a // 10
        b = b * 10 #переменная b равна b * 10
        b += number #поменял "+" и "=" местами /// к переменной b добовляется переменная number
...
#''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    print() #выводит в консоль пустую строку
    if c % 2 == 0: #условие: если переменная c % 2 равна 0 то -->
    ...
    while c != 1: #цикл: пока переменная c не равна 1 -->
            if c % 2 == 0: #условие: если переменная c % 2 равна 0 то -->
                    c = c / 2 #переменная c равна c / 2
            else: #условие: иначе -->
                    c = (3*c + 1) / 2 #переменная c равна (3*c + 1) / 2
